...
<body>
	...
	String searchType = "도시형생활주택"; 
	List<Realestate> RealeList = dao.getTypeRealestateInfo(INTERMEDIARY_ID, searchType);
	%>
	<header>
	<!-- 로고 및 상단 버튼 -->
        	...
        	<h1 style="padding:40px" >등록 매물 조회</h1>
         	...
         	<article class="main">
                <div class="type_box">
                    <div class="type_list">
                        <ul class="type">
                            <li><a href="RealestateAllSearch.jsp">전체매물</a></li>
                            <li><a href="addApartmentType.jsp">아파트</a></li>
                            <li><a href="addVillaType.jsp">빌라</a></li>
                            <li style="color: #5887d6;"><a href="addOfficetelType.jsp">도시형생활주택</a></li>
